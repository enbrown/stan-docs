...
\quad\mathsf{for}\quad n \in \{ 1, \dotsc, N \}.
$$
...
\quad\mathsf{for}\quad j \in \{ 1, \dotsc, J \}.
$$
...
\quad\mathsf{for}\quad k \in \{ 1, \dotsc, K \}
\quad\mathsf{constrained\ by}\quad \tau_k > 0.
$$
